...
// To use this, simply put this file in the folder of your map and use this line in your script:
// import { Text } from "./text_v2.ts"

// Text to objects doesn't really work but there's no reason to use it since geometry isn't lightable in v2 anyways.
// TLDR: JUST use Text.toWalls("blahblahblah") and NOT Text.toObjects("blahblahblah")
// IF you have any questions, feel free to DM me on discord: @obamart
